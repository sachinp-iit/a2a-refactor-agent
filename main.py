...
def main_menu():
    ...
    while True:
        ...
        if choice == "1":
            ...
            # Use DB_DIR inside repo path
            repo_db_dir = os.path.join(repo_path, "chroma_db")
            embedding_agent = EmbeddingAgent(json_report_path, repo_db_dir, chroma_client=SHARED_CHROMA_CLIENT)
